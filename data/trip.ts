export const trip = {
  ...
  itinerary: [
    ...
    { date: "15/10", from: "ATH", to: "JTR", status: "ok", tag: "Voo · OK", detail: "Ryanair FR1232 · 06h00 → 06h50 · ref SVDSSI · só mochila de mão (40x20x25) · check-in no app abre 14/10 06h" },
  ...
  flights: {
    confirmed: [
      ...
      { from: "ATH", to: "JTR", airline: "Ryanair · FR1232", date: "15/10", time: "06h00 → 06h50", ref: "SVDSSI" },
  ...
  checklist: [
    ...
    { text: "Passagem ATH→JTR (Ryanair FR1232 15/10 06h00) comprada · ref SVDSSI", done: true, priority: "OK" },
