export const trip = {
  ...
  checklist: [
    ...
    { text: "📶 COMPRAR chip Vodafone no aeroporto do Cairo na chegada — EGP 505 (~US$ 10) por 30 GB + minutos, 30 dias. Levar o PASSAPORTE FÍSICO (registro é obrigatório por lei, leva até 1h). É a sua internet PRINCIPAL de trabalho, não reserva: rotear pro notebook, celular na tomada. ⚠️ 30 GB é justo — chamada de vídeo come ~1,2 GB/hora, então 4h/dia por 5 dias já são ~24 GB. Conte com 1 recarga, ~US$ 20-25 no Egito todo. Economia: wi-fi do hotel pra e-mail e download, dados do chip SÓ pra chamada de vídeo", done: false, priority: "ALTA" },
