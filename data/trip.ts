export const trip = {
  ...
  checklist: [
    ...
    { text: "🎯 Aporte 3 de 5 · feito ✓ ADIANTADO em 03/09 (R$ 2.800, R$ 298 acima do previsto) — FECHOU AS DUAS METAS DA WISE de uma vez: dia a dia em US$ 4.048 e Ray-Ban em AED 2.034. Ainda sobrou pro Revolut", done: true, priority: "OK" },
    { text: "🎯 Aporte 4 de 5 · R$ 2.306 até 15/09 → tudo pro Revolut, FECHA a reserva de emergência: faltam € 225 (R$ 1.328) + US$ 188 (R$ 978)", done: false, priority: "ALTA" },
    { text: "🎯 Aporte 5 de 5 · R$ 3.555 até 20/09 → dinheiro físico: US$ 400 (R$ 2.080) + € 250 (R$ 1.475), SEPARADO dos US$ 4.000. São 400 e não 250 porque o Life Pyramids Inn (Giza) e o hotel de Luxor só aceitam DINHEIRO", done: false, priority: "MÉDIA" },
  ...
  moneyPlan: {
    ...
    missingTotal: "~R$ 5.861 em 2 aportes: R$ 2.306 (15/09) + R$ 3.555 (20/09). ✅ Wise FECHADA em US$ 4.048 e Ray-Ban FECHADO em AED 2.034 — o aporte de R$ 2.800 em 03/09 bateu as duas metas de uma vez. O que falta: € 225 + US$ 188 pra fechar a reserva do Revolut (R$ 2.306) + US$ 400/€ 250 em espécie (R$ 3.555). 💡 As hospedagens que faltam (Downtown ~US$ 222, 4ª noite Santorini ~€ 43, hostel Istambul ~US$ 60) cabem na Nomad SE o reembolso da Kuwait cair — sem ele faltam ~US$ 165. Fora dos aportes fica só o seguro (~R$ 330/mês)",
  },
