export const trip = {
  ...
  hostelRules: {
    ...
    perHostel: [
      ...
      },
      {
        ...
        rules: [
          "🚨 CHECK-IN É 13h-18h NA CONFIRMAÇÃO, mesmo a página anunciando recepção 24h. Você chega ~23h30 e declarou 22h-23h. MANDAR MENSAGEM pelo chat do Booking exigindo confirmação por escrito de que tem alguém na recepção — sem isso a reserva pode virar no-show. Telefone direto: +20 2 25770250",
  ...
  checklist: [
    ...
    { text: "🚨 CONFIRMAR CHECK-IN TARDIO NO CHEERS — a confirmação diz janela de 13h às 18h, mas você chega ~23h30 (declarou 22h-23h). Mandar mensagem pelo chat do Booking exigindo resposta POR ESCRITO de que tem recepção nesse horário. Sem isso, risco de no-show e de ficar na rua às 23h30 no Cairo", done: false, priority: "CRÍTICA" },
    ...
    { text: "💵 Dinheiro em espécie que o Egito exige: visto US$ 25 + Happiness Luxor US$ 82,90 + Life Pyramids US$ 160,49 = US$ 268,39. O saque de US$ 400 em Dubai cobre com folga", done: true, priority: "OK" },
