export const trip = {
  ...
  checklist: [
    ...
    { text: "🧳 Kuwait DXB→CAI: confirmar franquia no E-MAIL de emissão (buscar 'X44YYV' no Gmail upboostpro, e-ticket mostra 'BAG: 2PC' ou similar) — padrão Economy é 2x23kg", done: false, priority: "ALTA" },
