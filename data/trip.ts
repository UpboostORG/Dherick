export const trip = {
  ...
  checklist: [
    ...
    { text: "🔁 CONFERIR TODAS AS PASSAGENS AGORA e depois a cada ~2 semanas até embarcar — companhia muda horário sozinha e nem sempre avisa direito. Abrir cada localizador no app/site: ELAAQM (GOL) · BYYAHN (Emirates) · YIITAH (EgyptAir) · XZECPY (Aegean) · SVD5SI e T8EMHK (Ryanair) · KPPSWK (Sky Express) · BW5302849 e BW5416971 (Go Bus)", done: false, priority: "ALTA" },
