export const trip = {
  ...
  checklist: [
    ...
    { text: "🎯 Aporte 1 de 6 · feito ✓ — Wise saiu de US$ 2.613 pra US$ 3.033 e a dívida dos Ray-Ban foi quitada", done: true, priority: "OK" },
    { text: "🎯 Aporte 2 de 6 · feito ✓ ADIANTADO em 20/08 (R$ 3.400, aproveitando a baixa do dólar) — Wise foi de US$ 3.033 pra US$ 3.683. A data de 30/08 fica livre", done: true, priority: "OK" },
    { text: "🎯 Aporte 3 de 6 · feito ✓ ADIANTADO em 03/09 (R$ 2.800, R$ 298 acima do previsto) — FECHOU AS DUAS METAS DA WISE de uma vez: dia a dia em US$ 4.048 e Ray-Ban em AED 2.034. Ainda sobrou pro Revolut", done: true, priority: "OK" },
    { text: "🎯 Aporte 4 de 6 · R$ 2.306 até 15/09 → tudo pro Revolut, FECHA a reserva de emergência: faltam € 225 (R$ 1.328) + US$ 188 (R$ 978)", done: false, priority: "ALTA" },
    { text: "🎯 Aporte 5 de 6 · R$ 3.555 até 20/09 → dinheiro físico: US$ 400 (R$ 2.080) + € 250 (R$ 1.475), SEPARADO dos US$ 4.000. São 400 e não 250 porque o Life Pyramids Inn (Giza) e o hotel de Luxor só aceitam DINHEIRO", done: false, priority: "MÉDIA" },
    { text: "🎯 Aporte 6 de 6 · R$ 2.360 até 22/09 → € 400 EM EURO na conta da Wise (saldo digital, não espécie). Com euro já comprado, o cartão da Wise debita direto na Grécia e nos Bálcãs, sem conversão na hora do gasto", done: false, priority: "MÉDIA" },
  ...
  moneyPlan: {
    ...
    missingTotal: "~R$ 8.221 em 3 aportes: R$ 2.306 (15/09) + R$ 3.555 (20/09) + R$ 2.360 (22/09). ✅ Wise FECHADA em US$ 4.048 e Ray-Ban FECHADO em AED 2.034 — o aporte de R$ 2.800 em 03/09 bateu as duas metas de uma vez. O que falta: € 225 + US$ 188 pra fechar a reserva do Revolut (R$ 2.306) + US$ 400/€ 250 em espécie (R$ 3.555) + € 400 digitais na Wise (R$ 2.360). 💡 As hospedagens que faltam (Downtown ~US$ 222, 4ª noite Santorini ~€ 43, hostel Istambul ~US$ 60) cabem na Nomad SE o reembolso da Kuwait cair — sem ele faltam ~US$ 165. Fora dos aportes fica só o seguro (~R$ 330/mês)",
  },
