export const trip = {
  ...
  checklist: [
    ...
    { text: "🎯 Aporte 3 de 5 · R$ 2.871 até 05/09 → R$ 1.648 FECHAM a Wise nos US$ 4.000 + R$ 566 viram AED 400 + R$ 657 pro Revolut", done: false, priority: "ALTA" },
    { text: "🎯 Aporte 4 de 5 · R$ 2.871 até 15/09 → tudo pro Revolut, fecha a reserva (€ 322 + US$ 313)", done: false, priority: "MÉDIA" },
  ...
  moneyPlan: {
    ...
    missingTotal: "~R$ 8.517 em 3 aportes: R$ 2.871 (05/09) + R$ 2.871 (15/09) + R$ 2.775 (20/09) — a data de 30/08 saiu do calendário porque você adiantou R$ 3.400 em 20/08 na baixa do dólar. Compõem: US$ 317 dia a dia (R$ 1.648) + € 322/US$ 313 de reserva (R$ 3.528) + AED 400 pros Ray-Ban (R$ 566) + US$ 250/€ 250 em espécie (R$ 2.775). 💡 As 3 hospedagens que faltam (Downtown ~US$75, 4ª noite Santorini ~€43, hostel Istambul ~US$60 = ~US$ 184) JÁ CABEM na sobra da Nomad: com US$ 290 + US$ 300 do reembolso, e só ~US$ 110 devidos no cartão, sobram ~US$ 480. Fora dos aportes ficam só seguro (~R$ 600) e vacinas (~R$ 300)",
  },
