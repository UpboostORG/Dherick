export const trip = {
  ...
  itinerary: [
    ...
    { date: "30/09-08/10", place: "Cairo · Downtown", status: "warning", tag: "8 noites · a reservar", detail: "Fase de TRABALHO no Landmark Hostel (5 Kasr Al Nile): wi-fi nota 9,8, recepção 24h, check-in até 00:00 e 3 min a pé do Tahrir. Daqui você vai de Uber às pirâmides, ao GEM e ao Khan el-Khalili. Reservado até 08/10 (não 05) pra mala ficar no quarto durante Luxor e ter banho na volta do ônibus." },
  ...
  accommodation: {
    ...
    toBook: [
      { city: "Cairo — Landmark Hostel (Downtown)", dates: "30/09-08/10 · 8 noites", priority: "PENDENTE", estimate: "R$ 389 com cancelamento grátis (ou R$ 350 não reembolsável) · 5 Kasr Al Nile · 9,1 com 552 avaliações · WI-FI 9,8 · recepção 24h e check-in até 00:00 · 3 min a pé da Praça Tahrir" },
  ...
  accommodationCosts: {
    ...
    stays: [
      ...
      {
        city: "Cairo — Downtown", name: "Landmark Hostel Cairo (5 Kasr Al Nile)", dates: "30/09-08/10 · 8 noites",
        ref: "a reservar", status: "A RESERVAR",
        totalLabel: "R$ 389", paidLabel: "—", dueLabel: "R$ 389 (cancelamento grátis)",
        paidEur: 0, dueEur: 0, dueUsd: 0, estEur: 0,
        note: "🏆 WI-FI NOTA 9,8 — a melhor da rota, e é a sua fase de trabalho · 9,1 geral com 552 avaliações · recepção 24h e CHECK-IN ATÉ 00:00 (resolve sua chegada 23h30) · 3 min a pé da Praça Tahrir, onde o ônibus de Luxor te devolve · dormitório 6 camas com BANHEIRO PRIVATIVO, ar-condicionado e MESA DE TRABALHO · café da manhã incluído · reservar 8 noites (não 5) pra mala ficar no seu próprio quarto durante Luxor e ter banho na volta do ônibus dia 08",
      },
      {
  ...
  checklist: [
    ...
    { text: "🏨 RESERVAR o LIFE PYRAMIDS INN (5 Safi eldien st, Giza) pra 08-12/10 — Quarto Individual R$ 831, 9,4 com 1.021 avaliações, wi-fi 8,7, recepção 24h, terraço com vista das pirâmides, 5 min a pé da entrada. Cancelamento grátis até 07/10 e NÃO precisa nem de cartão pra reservar", done: false, priority: "ALTA" },
    { text: "💵 Life Pyramids Inn SÓ ACEITA DINHEIRO — ~US$ 160 em espécie. Perguntar pelo chat do Booking se aceitam EGP ou cartão; se não, sai do saque de Dubai", done: false, priority: "ALTA" },
    ...
    { text: "❌ CANCELAR o King's Gate depois que o Life Pyramids estiver confirmado — nessa ordem, nunca o contrário. Cancelamento é grátis", done: false, priority: "ALTA" },
    { text: "🏨 RESERVAR o LANDMARK HOSTEL CAIRO (5 Kasr Al Nile, Downtown) pra 30/09-08/10 — 8 noites, R$ 389 com cancelamento grátis, paga só em 28/09. Wi-fi nota 9,8 (a melhor da rota), recepção 24h, check-in até 00:00, 3 min a pé do Tahrir. Reservar as 8 noites e não 5: a mala fica no seu quarto durante Luxor e você tem banho na volta do ônibus dia 08", done: false, priority: "ALTA" },
  ...
  moneyPlan: {
    ...
    cash: [
      ...
      { label: "⚠️ TROCAR ~US$ 270 dos AED por DÓLAR em Dubai", desc: "O caixa eletrônico solta AED, mas você precisa de dólar EM ESPÉCIE em três lugares onde nada mais serve: Life Pyramids Inn em Giza (~US$ 160, só dinheiro) + hotel de Luxor (US$ 82,90, só dinheiro) + visto do Egito na chegada (US$ 25). Trocar numa casa de câmbio de Dubai (Al Ansari, Sharaf, nos shoppings) — spread lá é dos menores do mundo e não tem IOF. Peça notas novas e inteiras: o Egito recusa nota rasgada ou antiga", tag: "OBRIGATÓRIO" },
