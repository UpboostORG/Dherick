export const trip = {
  ...
  itinerary: [
    ...
    { date: "30/09-06/10", place: "Cairo · Downtown", status: "warning", tag: "6 diárias · HOTEL a reservar", detail: "Fase de TRABALHO, feita DO QUARTO — internet pelo chip Vodafone (~56 Mbps de mediana móvel no Egito, contra 5-15 do wi-fi de hotel barato). Hotel: Meramees ou New Panorama, recepção 24h obrigatória (desembarca 21h40, chega ~23h30). Consoleya fica de plano B pra call decisiva, EGP 250 o dia. ⚠️ CAIRO FICA 7H À FRENTE DE CUIABÁ: expediente comercial brasileiro cai entre 16h e 01h no Cairo. ⚠️ Com o King's Gate cancelado, esta é a sua única cama do dia 30. Checkout dia 06 e não 05: a diária extra garante quarto e banho até sair pro Go Bus às 21h do dia 05. A mala vai junto pro Luxor." },
  ...
  checklist: [
    ...
    { text: "🏨 RESERVAR HOTEL NO DOWNTOWN pra 30/09-06/10 — última peça do Egito e sua única cama do dia 30. 🏆 MERAMEES HOTEL (32 Sabry Abo Alam): 9,1 com 139 avaliações, funcionários 9,7, limpeza 9,2, quarto de 20 m² COM VARANDA e banheiro no quarto por R$ 1.158, mais lounge e terraço pra trabalhar fora do quarto. Cancelamento grátis até 30/09 18h. 💰 Ou NEW PANORAMA PALACE (42 Talaat Harb): 8,2 com 204 avaliações, com elevador, R$ 716. ⚠️ Nos dois, o quarto barato anunciado é de banheiro COMPARTILHADO", done: false, priority: "CRÍTICA" },
    ...
    { text: "💳 DEVOLVER US$ 58 (~R$ 302) PRA NOMAD — o Priority e as 2 bagagens de cabine da Ryanair saíram do cartão dos hotéis, que caiu de US$ 290 pra US$ 232. Repor devolve o bolso ao tamanho planejado. Vira URGENTE se o reembolso da Kuwait não cair", done: false, priority: "MÉDIA" },
    ...
    { text: "🎯 Aporte 4 de 7 · R$ 1.100 O QUANTO ANTES → tudo pra NOMAD, que sai de US$ 232 pra US$ 444. É PONTE, não substituição do reembolso: o dinheiro da Kuwait é seu e continua contando no total, o que não é seu é a DATA dele. Sem esta ponte, a reserva do hotel do Downtown (pague-on-line) fica travada esperando um reembolso que já está atrasado. 💡 SE o reembolso cair antes de 15/09, a Nomad vai a US$ 744 contra US$ 397 a pagar — aí você TIRA R$ 1.100 do aporte de 15/09, que cai pra R$ 1.206. A ponte se recupera inteira", done: false, priority: "ALTA" },
  ...
  moneyPlan: {
    pockets: [
      ...
      { name: "Nomad — hotéis (no CARTÃO)", detail: "Saldo REAL hoje: US$ 232. Era US$ 290 e os US$ 58 já saíram — foram o Priority + 2 bagagens de cabine dos voos da Ryanair pra Santorini. A pagar no cartão: Dubai € 60,78 (~US$ 69) + hotel do Downtown (~US$ 222) + 4ª noite de Santorini (~€ 43) + hostel de Istambul (~US$ 60) = ~US$ 397. ⚠️ O King's Gate saiu da conta (vai ser cancelado) e o Life Pyramids é DINHEIRO, não cartão", status: "US$ 232 hoje · com o aporte-ponte de R$ 1.100 vai a US$ 444 e fecha sozinha (sobra US$ 47) · quando o reembolso da Kuwait cair, vai a US$ 744 e sobram US$ 347", done: false },
    ...
    missingTotal: "~R$ 9.321 em 4 aportes rumo à META GERAL de R$ 35.000 seus ao embarcar: R$ 1.100 (o quanto antes, pra Nomad) + R$ 2.306 (15/09) + R$ 3.555 (20/09) + R$ 2.360 (22/09). ✅ Wise FECHADA em US$ 4.048 e Ray-Ban FECHADO em AED 2.034 — o aporte de R$ 2.800 em 03/09 bateu as duas de uma vez. O que falta: R$ 1.100 pra Nomad parar de depender do reembolso da Kuwait + € 225/US$ 188 do Revolut (R$ 2.306) + US$ 400/€ 250 em espécie (R$ 3.555) + € 400 digitais na Wise (R$ 2.360). Fora dos aportes fica só o seguro (~R$ 330/mês)",
  },
  ...
  logistics: {
    ...
    connections: [
      ...
      },
      {
        ...
        margin: "depende da reserva nova", risk: "PLANEJAR",
        note: "⚠️ Com o King's Gate cancelado, você não tem mais cama nenhuma reservada pra esta noite. O hotel do Downtown TEM que ter recepção 24h: você pousa 21h40 no Terminal 3 e, com imigração, visto na chegada e Uber, chega ~23h30. Leve os US$ 25 do visto em dinheiro. O Downtown ainda é melhor que Giza aqui — fica ~15 min mais perto do aeroporto.",
      },
      {
