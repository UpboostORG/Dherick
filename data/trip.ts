    ...
    perHostel: [
      {
        ...
        rules: [
          "⚠️ Chegada de madrugada: seu voo pousa 23h do dia 25, você chega ~00h30 — avisar o hostel antes",
          "€ 60,78 (~AED 255) em aberto — confirmar com o hostel como cobram (Hostelworld mostra AED 0 no local)",
          "Dia 30: checkout ~7h com a mala, direto pro AWS Summit (não dá pra voltar depois)",
      ...
      },
      {
        ...
        rules: [
          "€ 42,71 em DINHEIRO na chegada (pagou só US$ 14,55 de sinal)",
          "NÃO reembolsável — não dá pra cancelar",
          "Dormitório misto de 10 camas · 25 Menandrou (perto de Omonia)",
          "Chega dia 12 às 6h da manhã: deixa a mochila e vai direto pra Acrópole (abre 8h)",
