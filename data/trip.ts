export const trip = {
  ...
  checklist: [
    ...
    { text: "📏 TESTE DA MALA quando chegar (comprada: N20, 54×33×23) — medir a ALTURA total com rodinha e alça recolhida (≤55cm), a PROFUNDIDADE no ponto mais gordo (≤23cm) e o PESO VAZIO na balança (ideal ≤3kg). Passou nos três, fica com ela; falhou em algum, devolve e pega a N19 (51×30×21)", done: false, priority: "ALTA" },
