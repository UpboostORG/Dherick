export const trip = {
  ...
  itinerary: [
    ...
    { date: "a definir", place: "Santorini", status: "warning", tag: "Falta tudo", detail: "Santorini. Passagem + hostel a reservar (temporada alta!)." },
  ...
  flights: {
    ...
    toBuy: [
      { from: "ATH", to: "Santorini", note: "A partir de 12/10 · voo ou ferry", priority: "ALTA" },
  ...
  accommodation: {
    ...
    toBook: [
      ...
      { city: "Santorini", dates: "A definir · temporada alta!", priority: "FALTA", estimate: "~€ 150 (hostel ~€ 30/noite)" },
