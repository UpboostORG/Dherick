export const trip = {
  ...
  checklist: [
    ...
    { text: "💵 SACAR pela Wise: US$250 em Dubai (set, sai AED) + US$250 no Egito (out, sai EGP) + €250 NA GRÉCIA (out, ao chegar em Atenas 12/10 — só lá sai euro de verdade) · US$250/€250 grátis por mês · sempre moeda LOCAL no caixa", done: false, priority: "MÉDIA" },
    { text: "🎯 Aporte 1 de 4 · R$ 3.000 até 17/08", done: false, priority: "ALTA" },
  ...
  moneyPlan: {
    ...
    cash: [
      { label: "🎯 SACAR US$ 500 pela Wise (confirmado: US$250/mês grátis)", desc: "Câmbio físico no Brasil perde 3-8% de spread + IOF 1,1% — nem cogitar. Saca US$ 250 em Dubai (set) + US$ 250 no Egito (out, limite reseta) = US$500 de graça, câmbio real. Cobre Luxor (só cash) + EGP + margem", tag: "OBRIGATÓRIO" },
      { label: "🎯 SACAR ~€ 220 pela Wise — precisa ser NA GRÉCIA, não no Egito", desc: "⚠️ Caixa eletrônico só solta a moeda local do país — no Egito sai EGP, nunca euro físico. Sacar ao chegar em Atenas (12/10): 1 saque cobre Athens Hawks € 42,71 + Caveland € 81,74 + € 10 caução + guarda-volumes, de graça (quota €250/mês)", tag: "OBRIGATÓRIO" },
