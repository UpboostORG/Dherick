export const trip = {
  ...
  checklist: [
    ...
    { text: "🎯 Aporte 2 de 4 · R$ 3.041 até 30/08 → tudo pra Wise (dia a dia)", done: false, priority: "ALTA" },
    { text: "🎯 Aporte 3 de 4 · R$ 3.041 até 05/09 → R$ 1.987 fecham a Wise nos US$ 4.000 + R$ 566 viram AED 400 + R$ 488 pro Revolut", done: false, priority: "MÉDIA" },
    { text: "🎯 Aporte 4 de 4 · R$ 3.040 até 15/09 → tudo pro Revolut, fecha a reserva (€ 322 + US$ 313). Tudo pronto 9 dias antes de embarcar", done: false, priority: "MÉDIA" },
    ...
    { text: "📧 COBRAR o Kuwait por e-mail agora (metade do prazo) pedindo confirmação de que o reembolso está processando e uma previsão — não é pra apressar, é pra criar registro escrito que serve de prova no chargeback depois", done: false, priority: "MÉDIA" },
  ...
  moneyPlan: {
    ...
    missingTotal: "~R$ 9.122 em 3 aportes de ~R$ 3.041 (30/08, 05/09, 15/09): US$ 967 dia a dia (R$ 5.028) + € 322/US$ 313 de reserva (R$ 3.528) + AED 400 pros Ray-Ban (R$ 566). 💡 As 3 hospedagens que faltam (Downtown ~US$75, 4ª noite Santorini ~€43, hostel Istambul ~US$60 = ~US$ 184) JÁ CABEM na sobra da Nomad: com US$ 290 + US$ 300 do reembolso, e só ~US$ 110 devidos no cartão, sobram ~US$ 480. Fora do plano de aportes ficam só seguro (~R$ 600) e vacinas (~R$ 300)",
  },
