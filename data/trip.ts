export const trip = {
  ...
  checklist: [
    ...
    { text: "🎯 Aporte 5 de 5 · R$ 3.555 até 20/09 → dinheiro físico: US$ 400 (R$ 2.080) + € 250 (R$ 1.475), SEPARADO dos US$ 4.000. Subiu de US$250 pra 400 porque o Life Pyramids Inn (Giza) só aceita DINHEIRO", done: false, priority: "MÉDIA" },
  ...
  moneyPlan: {
    pockets: [
      ...
      { name: "Nomad — hotéis (no CARTÃO)", detail: "Dubai € 60,78 + Cairo US$ 124,20 (⚠️ se o Cairo for só dinheiro, sai do saque) · saldo US$ 290 − US$ 58 do Priority da Ryanair = US$ 232, + US$ 300 do reembolso a cair = US$ 532 · Landmark e hostel de Istambul somam quando reservar", status: "coberto ✓ (falta o reembolso cair)", done: true },
    ...
    missingTotal: "~R$ 8.559 em 3 aportes: R$ 2.502 (05/09) + R$ 2.502 (15/09) + R$ 3.555 (20/09). Compõem: US$ 317 dia a dia (R$ 1.648) + € 256/US$ 246 de reserva (R$ 2.790) + AED 400 pros Ray-Ban (R$ 566) + US$ 400/€ 250 em espécie (R$ 3.555). 💡 As 3 hospedagens que faltam (Downtown ~US$75, 4ª noite Santorini ~€43, hostel Istambul ~US$60 = ~US$ 184) JÁ CABEM na sobra da Nomad: com US$ 290 + US$ 300 do reembolso, e só ~US$ 110 devidos no cartão, sobram ~US$ 480. Fora dos aportes ficam só seguro (~R$ 600) e vacinas (~R$ 300)",
  },
