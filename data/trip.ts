export const trip = {
  ...
  accommodation: {
    ...
    toBook: [
      ...
      { city: "Santorini — 1 noite top", dates: "18-19/10 · última noite", priority: "PENDENTE", estimate: "~€ 150-250 (cave suite c/ vista da caldera, Imerovigli)" },
    ...
    stays: [
      {
        ...
        paidEur: 28.39, dueEur: 60.78, estEur: 0,
      ...
      },
      {
        ...
        ref: "5446189808", status: "VALOR PENDENTE",
        totalLabel: "a confirmar", paidLabel: "—", dueLabel: "a confirmar",
        paidEur: 0, dueEur: 0, estEur: 0,
        note: "Pagamento no local · pegar o valor no app do Booking (é a maior estadia: 12 noites)",
      },
      {
        city: "Luxor", name: "Happiness Guest House", dates: "05-08/10 · 3 noites",
        ref: "5285616723", status: "VALOR PENDENTE",
        totalLabel: "a confirmar", paidLabel: "—", dueLabel: "a confirmar",
        paidEur: 0, dueEur: 0, estEur: 0,
        note: "Pagamento no local · pegar o valor no app do Booking",
      },
      {
        ...
        paidEur: 12.44, dueEur: 42.71, estEur: 0,
        note: "NÃO reembolsável · dormitório misto 10 camas · 25 Menandrou",
      },
      {
        city: "Santorini", name: "hostel a reservar", dates: "15-19/10 · 4 noites",
        ref: "—", status: "A RESERVAR",
        totalLabel: "~€ 120", paidLabel: "—", dueLabel: "—",
        paidEur: 0, dueEur: 0, estEur: 120,
        note: "Caveland / Anemomilos (~€30/noite) · reservar com cancelamento grátis",
      },
      {
        city: "Santorini — noite top", name: "cave suite c/ vista da caldera", dates: "18-19/10 · 1 noite",
        ref: "—", status: "A RESERVAR",
        totalLabel: "~€ 150-250", paidLabel: "—", dueLabel: "—",
        paidEur: 0, dueEur: 0, estEur: 200,
        note: "Imerovigli sai 20-30% mais barato que Oia com a mesma vista · outubro é baixa temporada",
      },
      {
        city: "Istambul", name: "hostel a reservar", dates: "20/10 em diante · 15+ noites",
        ref: "—", status: "A RESERVAR",
        totalLabel: "~US$ 225", paidLabel: "—", dueLabel: "—",
        paidEur: 0, dueEur: 0, estEur: 192,
        note: "Reservar só os 3-4 primeiros dias e decidir o resto lá",
      },
    ],
  },
  ...
  checklist: [
    ...
    { text: "🧳 Kuwait DXB→CAI (X44YYV): economy padrão inclui 2x23kg — só confirmar franquia no Manage Booking", done: false, priority: "MÉDIA" },
