export const trip = {
  ...
  itinerary: [
    ...
    { date: "30/09-06/10", place: "Cairo · Downtown", status: "ok", tag: "6 diárias · RESERVADO", detail: "Fase de TRABALHO, feita DO QUARTO — internet pelo chip Vodafone (~56 Mbps de mediana móvel no Egito). CHEERS HOSTEL CAIRO, 34 Talaat Harb, 3º andar · R$ 920 cobrados no Nomad em 28/09 · café da manhã incluso · recepção 24h e elevador (chega ~23h30, tranquilo) · wi-fi 8,9. Consoleya fica de plano B pra call decisiva, EGP 250 o dia. ⚠️ CAIRO FICA 7H À FRENTE DE CUIABÁ: expediente comercial brasileiro cai entre 16h e 01h no Cairo. Checkout dia 06 e não 05 de propósito: garante quarto e banho até sair pro Go Bus às 21h do dia 05. A mala vai junto pro Luxor." },
  ...
  accommodation: {
    confirmed: [
      ...
      },
      {
        ...
        checkIn: "30/09 · recepção 24 HORAS",
        checkOut: "06/10 · até 11h — mas você só sai pro Go Bus às 21h do dia 05",
        confirmation: "a preencher",
        pin: "a preencher",
        tel: "—",
        note: "✅ RESERVADO. 6 diárias · café da manhã incluso · banheiro privativo, ar-condicionado, TV, frigobar, cofre, purificador de ar e mosquiteiro no quarto. Prédio tem ELEVADOR, recepção 24h, limpeza diária, lavanderia, cozinha compartilhada e lounge. Notas sobre 317 avaliações: geral 9,0 · funcionários 9,7 · localização 9,5 · custo-benefício 9,3 · WI-FI 8,9. Cancelamento grátis até 30/09 às 18h — dá pra desistir até o dia em que você pousa. 💡 Escolhido no lugar do Swisstay (30 m², mas sem tarifa cancelável e sem elevador confirmado no 6º andar) e do Soft Hotel (wi-fi 9,5, mas R$ 1.676 na tarifa cancelável)",
        price: "R$ 920 · COBRADO NO CARTÃO NOMAD EM 28/09, não no check-in",
      },
      {
        city: "Giza",
  ...
  accommodationCosts: {
    ...
    stays: [
      ...
      },
      {
        ...
        ref: "a preencher", status: "PAGO",
        totalLabel: "R$ 920 (~US$ 177)", paidLabel: "cobrado 28/09 no Nomad", dueLabel: "—",
  ...
  hostelRules: {
    ...
    perHostel: [
      ...
      },
      {
        ...
        dates: "30/09-06/10 · 6 diárias", ref: "a preencher",
        rules: [
          "✅ RECEPÇÃO 24 HORAS — resolve a sua chegada às 23h30 do dia 30. Não precisa avisar nem pagar taxa de check-in tardio",
          "✅ Já PAGO: R$ 920 caem no cartão Nomad em 28/09. No balcão você não paga nada",
          "🚨 NÃO cancele a reserva do Booking se pedirem no balcão, e não entregue o celular a ninguém da recepção",
          "Prédio tem ELEVADOR — 3º andar com mala não é problema",
          "Café da manhã incluso. Wi-fi nota 8,9, mas a internet de trabalho é o chip Vodafone",
          "Cancelamento grátis até 30/09 às 18h — o próprio dia em que você pousa",
          "Dia 05/10 você sai pro Go Bus às 21h, mas o quarto é seu até o dia 06: tome banho antes de encarar 9h de ônibus",
          "⚠️ Anotar aqui o número da reserva e o PIN quando o e-mail chegar",
        ],
      },
      {
  ...
  checklist: [
    ...
    { text: "❌ CANCELAR o King's Gate (ref 5446189808) — DESTRAVADO: Life Pyramids e Cheers Hostel confirmados, você tem cama em todas as noites do Egito. Cancelamento é grátis. Fazer pelo próprio Booking, nunca por telefone nem a pedido do hotel", done: false, priority: "CRÍTICA" },
    { text: "✅ CHEERS HOSTEL CAIRO RESERVADO — 30/09-06/10, 34 Talaat Harb 3º andar, R$ 920 cobrados no Nomad em 28/09 · café da manhã incluso · recepção 24h e ELEVADOR · wi-fi 8,9 · 9,0 com 317 avaliações · cancelamento grátis até 30/09 18h. ⚠️ Anotar o número da reserva e o PIN aqui quando chegar o e-mail", done: true, priority: "OK" },
  ...
  logistics: {
    ...
    connections: [
      ...
      },
      {
        ...
        margin: "resolvido", risk: "OK",
        note: "✅ Resolvido: o Cheers Hostel tem RECEPÇÃO 24 HORAS, então chegar ~23h30 não é problema e não precisa avisar ninguém. Pousa 21h40 no Terminal 3, passa imigração, tira o visto (leve os US$ 25 EM DINHEIRO) e pega Uber até 34 Talaat Harb. Aproveite o balcão do aeroporto pra comprar o chip Vodafone — leve o passaporte.",
      },
      {
