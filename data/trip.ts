export const trip = {
  ...
  accommodationCosts: {
    ...
    stays: [
      ...
      },
      {
        ...
        totalLabel: "€ 89,11", paidLabel: "US$ 16,34 (€ 7,37 de sinal + taxa Hostelworld)", dueLabel: "€ 81,74 + €10 caução",
  ...
  budget: {
    ...
    currencies: [
      ...
      { code: "EUR", name: "Grécia", desc: "Cartão aceito em toda parte · cash € 250 (saque Wise ao chegar em Atenas): Athens Hawks €42,71 + Caveland €81,74 + €10 caução + guarda-volumes ~€35 = ~€170, sobra de margem", rate: "R$ 5,90" },
    ...
    pending: ["2 hospedagens (noite top Santorini, Istambul)", "Seguro viagem"],
  },
  ...
  moneyPlan: {
    pockets: [
      ...
      { name: "Hotéis que só aceitam DINHEIRO", detail: "Luxor US$ 82,90 (sai do saque de Dubai) + Atenas € 42,71 + Caveland € 81,74 + € 10 caução (saem do saque de € 250 em Atenas) · não passa no cartão, não adianta ter saldo na Nomad", status: "coberto pelos 2 saques ✓", done: true },
