export const trip = {
  ...
  itinerary: [
    ...
    { date: "15-22/10", place: "Santorini", status: "warning", tag: "7 noites · hostel falta", detail: "Santorini. Passagem + hostel a reservar." },
    { date: "22/10", from: "JTR", to: "IST", status: "warning", tag: "Voo · a comprar", detail: "Aegean · 14h10 → 15h35 · direto · R$567 (combo com ATH→JTR)" },
    { date: "22/10 em diante", place: "Istambul", status: "warning", tag: "15+ dias", detail: "Istambul: Hagia Sophia, Bazar, Bósforo. Sem data de saída — destino aberto depois." },
  ],
  ...
  flights: {
    ...
    toBuy: [
      { from: "ATH", to: "Santorini", note: "Ryanair 15/10 06h00→06h50 direto · comprar até ago/26", priority: "ALTA" },
      { from: "Santorini", to: "Istambul", note: "Aegean 22/10 14h10→15h35 direto · comprar até ago/26", priority: "ALTA" },
    ],
  },
  ...
  accommodation: {
    ...
    toBook: [
      ...
      { city: "Santorini", dates: "15-22/10 · 7 noites", priority: "FALTA", estimate: "~€ 210 (hostel ~€ 30/noite)" },
      { city: "Istambul", dates: "22/10 em diante · 15+ dias", priority: "FALTA", estimate: "~US$ 225 (hostel ~US$ 15/noite)" },
    ],
    hostelTips: [
  ...
  checklist: [
    ...
    { text: "✈ Passagem ATH → Santorini · Ryanair 15/10 06h00 direto · comprar até ago/26", done: false, priority: "ALTA" },
    { text: "✈ Passagem Santorini → Istambul · Aegean 22/10 14h10 direto · comprar até ago/26", done: false, priority: "ALTA" },
    { text: "🏨 Reservar hostel Atenas · 12-15/10 (3 noites) · reservar até ago/26", done: false, priority: "ALTA" },
    { text: "🏨 Reservar hostel Santorini · 15-22/10 (7 noites) · reservar até ago/26", done: false, priority: "ALTA" },
    { text: "🏨 Reservar hostel Istambul · 22/10 em diante (15+ dias) · reservar até set/26", done: false, priority: "MÉDIA" },
  ...
  budget: {
    ...
    pending: ["6 hostels a reservar", "4 passagens a comprar", "Seguro viagem"],
  },
