export const trip = {
  ...
  checklist: [
    ...
    { text: "🧪 TESTAR CHAMADA PELO eSIM antes de acionar a VPN, no 1º dia dos Emirados E do Egito — os dois países bloqueiam chamada de WhatsApp, FaceTime e Skype, mas o tráfego de eSIM sai por gateway internacional e às vezes fura o bloqueio. Não é garantido; se funcionar, você poupa VPN em toda reunião", done: false, priority: "MÉDIA" },
