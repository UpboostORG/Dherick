export const trip = {
  ...
  checklist: [
    ...
    { text: "🚨 SUA MOCHILA NÃO PASSA NA RYANAIR — a Romantic Crown é 45×32×12 e o limite grátis é 40×20×25. Estoura em duas medidas. Pega nos voos de 15/10 e 20/10, onde ela seria sua ÚNICA bagagem (a mala fica em Atenas)", done: false, priority: "ALTA" },
    { text: "🎒 COMPRAR uma mochila dobrável de 20-25L (~R$ 50-150, pesa 200-300g) que caiba em 40×20×25 — sai bem mais barato que pagar bagageiro da Ryanair nos 2 trechos (~R$ 300-700), e vira sua mochila de passeio na viagem inteira. Em Santorini no calor, 5 dias cabem em 25L", done: false, priority: "ALTA" },
