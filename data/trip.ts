export const trip = {
  ...
  checklist: [
    ...
    { text: "💵 SACAR (não comprar) pela Wise: US$250 em Dubai (set) + US$250 no Egito (out) + €220 na Grécia (out, saldo separado) — confirmado US$250/€250 grátis por mês · sempre escolher moeda LOCAL no caixa, nunca BRL", done: false, priority: "MÉDIA" },
  ...
  moneyPlan: {
    ...
    cash: [
      ...
      { label: "🎯 SACAR ~€ 220 pela Wise (confirmado: €250/mês grátis)", desc: "Mesmo saldo mês de outubro do saque em USD, mas balanço EUR separado — não conflita. 1 saque na Grécia cobre Athens Hawks € 42,71 + Caveland € 81,74 + € 10 caução + guarda-volumes, tudo de graça", tag: "OBRIGATÓRIO" },
