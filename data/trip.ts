export const trip = {
  ...
  checklist: [
    ...
    { text: "🎯 Aporte 2 de 5 · R$ 3.041 até 30/08 → tudo pra Wise (dia a dia)", done: false, priority: "ALTA" },
    { text: "🎯 Aporte 3 de 5 · R$ 3.041 até 05/09 → R$ 1.987 fecham a Wise nos US$ 4.000 + R$ 566 viram AED 400 + R$ 488 pro Revolut", done: false, priority: "MÉDIA" },
    { text: "🎯 Aporte 4 de 5 · R$ 3.040 até 15/09 → tudo pro Revolut, fecha a reserva (€ 322 + US$ 313)", done: false, priority: "MÉDIA" },
