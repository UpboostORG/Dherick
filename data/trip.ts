export const trip = {
  ...
  checklist: [
    ...
    { text: "🎯 Aporte 1 de 4 · R$ 3.606 até 17/08 → Wise (dia a dia)", done: false, priority: "ALTA" },
    { text: "🎯 Aporte 2 de 4 · R$ 3.606 até 29/08 → Wise (dia a dia) — fecha os US$ 1.387 que faltam pro dia a dia", done: false, priority: "MÉDIA" },
    { text: "🎯 Aporte 3 de 4 · R$ 3.744 até 10/09 → Revolut (reserva) + Wise (repor os AED 1.025 dos óculos)", done: false, priority: "MÉDIA" },
    { text: "🎯 Aporte 4 de 4 · R$ 2.294 até 22/09 → Revolut (reserva) — fecha a reserva de emergência (€411 + US$416)", done: false, priority: "MÉDIA" },
