export const trip = {
  ...
  itinerary: [
    ...
    { date: "03-08/10", place: "Cairo", status: "warning", tag: "5 noites · hostel falta", detail: "Bate-volta Luxor, Alexandria, explorar mais o Cairo. Hostel a reservar." },
    ...
    { date: "12-17/10", place: "Atenas", status: "warning", tag: "~5 noites · hostel falta", detail: "Acrópole, Plaka, Monastiraki. Hostel a reservar." },
    { date: "a definir", place: "Ilhas Gregas", status: "warning", tag: "Falta tudo", detail: "Santorini / Mykonos / Creta / Rhodes. Passagem + hostel a reservar (temporada alta!)." },
  ...
  accommodation: {
    ...
    toBook: [
      ...
      { city: "Cairo (após 03/10)", dates: "03/10 a 12/10 · ~9 noites", priority: "FALTA", estimate: "~US$ 100 (hostel ~US$ 12/noite)" },
      { city: "Atenas", dates: "12-17/10 · ~5 noites", priority: "FALTA", estimate: "~€ 100 (hostel ~€ 20/noite)" },
      { city: "Ilhas Gregas", dates: "A definir · temporada alta!", priority: "FALTA", estimate: "~€ 150 (hostel ~€ 30/noite)" },
    ...
    hostelTips: [
      ...
      { city: "Ilhas Gregas", hostels: ["Anemomilos Hostel (Santorini)", "Mykonos Backpacker"], priceRange: "€ 20-35/noite" },
  ...
  checklist: [
    ...
    { text: "Reservar hostel Cairo após 03/10", done: false, priority: "ALTA" },
    { text: "Comprar passagem ATH → Ilhas Gregas", done: false, priority: "ALTA" },
    { text: "Reservar hostel Atenas", done: false, priority: "ALTA" },
    { text: "Reservar hostel Ilhas Gregas", done: false, priority: "ALTA" },
  ...
  budget: {
    ...
    distribution: [
      ...
      { destination: "Grécia (Atenas + ilhas)", amount: 550 },
  ...
  monthlyPurchases: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "Reservar hostel Ilhas Gregas (~5 noites)", cost: "~€ 150", done: false },
