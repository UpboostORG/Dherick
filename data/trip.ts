export const trip = {
  ...
  checklist: [
    ...
    { text: "💳 DEVOLVER US$ 58 (~R$ 302) PRA NOMAD — o Priority da Ryanair saiu do cartão dos hotéis. A Nomad tem folga, então não é urgente, mas é dinheiro de outro bolso", done: false, priority: "MÉDIA" },
  ...
  moneyPlan: {
    pockets: [
      ...
      { name: "Nomad — hotéis (no CARTÃO)", detail: "Dubai € 60,78 (~US$ 69) + hotel do Downtown + 4ª noite de Santorini (~€ 43) + hostel de Istambul (~US$ 60). ⚠️ O King's Gate saiu da conta (vai ser cancelado) e o Life Pyramids é DINHEIRO, não cartão · saldo US$ 290 − US$ 58 do Priority da Ryanair = US$ 232, + US$ 300 do reembolso da Kuwait a cair = US$ 532", status: "⚠️ depende do reembolso da Kuwait cair", done: false },
      { name: "Dívida com a Nomad — Priority Ryanair", detail: "US$ 58 (2× US$ 29) do Priority + bagagem de cabine saíram do cartão dos hotéis. Repor ~R$ 302. 💡 A Nomad tem folga, então isso é organização, não urgência", status: "falta repor ~R$ 302", done: false },
