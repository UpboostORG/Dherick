export const trip = {
  ...
  checklist: [
    ...
    { text: "🚨 COMPRAR o bagageiro de mão da Ryanair ONLINE E CEDO, nos 2 trechos (14/10 e 19/10) — a Romantic Crown 45×32×12 cabe no limite pago deles (55×40×20). ATH→JTR confirmado em €22,60. No portão a multa vai até €75 — comprar online sempre. Fazer também no trecho de volta (19/10)", done: false, priority: "ALTA" },
