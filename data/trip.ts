export const trip = {
  ...
  itinerary: [
    ...
    { date: "30/09", from: "DXB", to: "CAI", status: "ok", tag: "Voo · CONFERIDO 08/09", detail: "EgyptAir MS906 · 19h00 → 21h40 · direto, 3h40, A320neo · ref YIITAH · e-ticket 077-2452932606 · conferido em 08/09: horário inalterado e voo confirmado. 🚨 PARTE DO TERMINAL 1 DE DUBAI, não do 3 — a Emirates te DEIXA no T3 na chegada, mas a EgyptAir sai do T1. Mandar o Uber pro Terminal 1. Chega no Terminal 3 do Cairo. ⚠️ Tarifa 'Economy Restricted' com 'No selected services' — a franquia de 2x23kg anotada antes precisa ser reconferida em Show flight details. Sai do AWS Summit 15h30 pro aeroporto." },
  ...
  checklist: [
    ...
    { text: "⚠️ EgyptAir DXB→CAI (YIITAH): RECONFERIR a franquia de bagagem — em 08/09 a reserva aparece como tarifa 'Economy Restricted' com 'No selected services', e a anotação de 2x23kg é anterior a isso. Abrir Show flight details no site. Não quebra o plano (você viaja de mão), mas o registro pode estar errado", done: false, priority: "MÉDIA" },
