export const trip = {
  ...
  accommodationCosts: {
    ...
    stays: [
      ...
      },
      {
        ...
        note: "🚨 CONFERIR SE ACEITA CARTÃO: o Booking hoje lista este hotel como SÓ DINHEIRO, contrariando o que estava anotado aqui. Se for cash mesmo, os US$ 124,20 saem do saque em espécie — junto com os US$ 82,90 de Luxor dá US$ 207 dos seus US$ 250, e sobra quase nada pros 12 dias de Egito · nota real hoje: 8,7 com 175 avaliações (o 9,8 que aparecia no Google era cache antigo, de 41) · wi-fi é a pior nota dele: 7,5",
      },
      {
  ...
  checklist: [
    ...
    { text: "🤔 Decidir a divisão da estadia no Cairo: 08-12/10 precisa ser em Giza (festival na pirâmide), mas 30/09-05/10 é livre. Zamalek/Downtown tem fibra, restaurante e coworking — Giza é bairro popular, poucas opções de comida e 45-75 min de tudo", done: false, priority: "MÉDIA" },
    ...
    { text: "🎯 Aporte 2 de 4 · R$ 2.852 até 29/08 → tudo pra Wise (dia a dia)", done: false, priority: "ALTA" },
    { text: "🎯 Aporte 3 de 4 · R$ 2.852 até 10/09 → R$ 2.176 fecham a Wise nos US$ 4.000 + R$ 676 pro Revolut", done: false, priority: "MÉDIA" },
    { text: "🎯 Aporte 4 de 4 · R$ 2.852 até 22/09 → tudo pro Revolut, fecha a reserva (€ 322 + US$ 313)", done: false, priority: "MÉDIA" },
  ...
  moneyPlan: {
    pockets: [
      ...
      { name: "Wise — Ray-Ban Meta (AED)", detail: "AED 1.600 separados pros óculos em Dubai · dívida da EgyptAir já quitada ✓ · cobre o preço da Amazon.ae (~AED 1.537)", status: "coberto ✓", done: true },
    ],
    cash: [
    ...
    missingTotal: "~R$ 8.556 fecham os bolsos que ainda faltam: US$ 967 dia a dia (R$ 5.028) + € 322/US$ 313 de reserva de emergência (R$ 3.528) · hotéis cobertos ✓ · Ray-Ban quitado ✓ · ainda vão somar: 4ª noite Santorini, hostel Istambul, seguro (~R$ 600) e vacinas",
  },
  ...
  logistics: {
    ...
    connections: [
      ...
      },
      {
        ...
        margin: "estoura o check-in", risk: "APERTADO",
        note: "🚨 Imigração + visto na chegada (US$ 25 em dinheiro) + 2 malas na esteira + Uber = hotel ~23h30, e o check-in fecha 23h. Só não vira problema se você AVISAR o hotel antes (+20 11 31402676).",
      },
      {
