export const trip = {
  ...
  checklist: [
    ...
    { text: "📧 TURQUIA — escrever pro TİTCK (+90 312 218 3316) perguntando se metilfenidato, que consta na proibição de importação que a Turquia notificou ao INCB, também vale pra viajante em tratamento. A alfândega turca é permissiva mas a notificação diz o contrário. É o item mais crítico em aberto — mandar ESTA SEMANA", done: false, priority: "ALTA" },
  ...
  medication: {
    ...
    pendingAnswers: [
      { what: "🇹🇷 Turquia — metilfenidato está na proibição do Artigo 13?", who: "TİTCK, +90 312 218 3316, ou consulado turco por escrito", why: "O item mais crítico em aberto. A alfândega diz uma coisa, a notificação ao INCB diz outra", when: "Antes de 20/10 — mandar esta semana" },
    ...
    countries: [
      ...
      {
        country: "🇹🇷 Turquia (20/10 em diante) ⚠️",
        lisdex: "Não é licenciada no país (zero produtos da classe em 45.758 registros). E como é pró-fármaco da dexanfetamina, cai na lista de proibições da Turquia, que inclui anfetamina e dexanfetamina",
        methyl: "🚨 CONTRADIÇÃO NÃO RESOLVIDA: a alfândega turca é permissiva ('quantidade razoável', declarando), mas a Turquia notificou ao INCB proibição de importação (Artigo 13) que INCLUI metilfenidato — e a diretriz do INCB diz que essa proibição 'também se aplica quando carregada por viajantes em tratamento'",
        atomox: "Livre",
        buy: "Existe no país (Concerta, Ritalina, Medikinet) via 'kırmızı reçete' de psiquiatra turco. Farmácia turca NÃO aceita receita estrangeira. Isso sugere que a proibição mira o canal comercial, não a molécula — mas ninguém confirmou",
        penalty: "🚨 RESOLVER POR ESCRITO ANTES DE 20/10 — TİTCK, +90 312 218 3316. É o item mais crítico em aberto",
      },
      {
