export const trip = {
  ...
  checklist: [
    ...
    { text: "🛡 ASSINAR O GENKI TRAVELER AINDA NO BRASIL, com início em 24/09 — isso não é detalhe: a carência de 14 dias (só cobre emergência) NÃO se aplica se no dia anterior ao início você estiver no seu país de origem. Assinando depois de embarcar, você fica 14 dias com meia proteção. ~€ 52,50/mês (R$ 310), € 1.000.000 de cobertura, franquia € 50 por caso e ZERO em internação. Região: escolher 'worldwide'", done: false, priority: "ALTA" },
