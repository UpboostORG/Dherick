  ...
  medication: {
    ...
    countries: [
      ...
      },
      {
        ...
        lisdex: "Sem proibição de importação. ⚠️ O 'certificado Schengen' NÃO serve pra você: por decisão da própria UE ele só é emitido a RESIDENTES do país. Brasileiro não consegue",
        methyl: "Sem proibição. Disponível no país (Concerta 18 e 36 mg)",
        atomox: "Livre",
        buy: "Concerta exige 'ειδική συνταγή ναρκωτικών' (receita especial de narcóticos) de psiquiatra ou neurologista grego. ⚠️ As exigências de 'autorização prévia do EOF' que circulam em sites de viagem NÃO têm respaldo oficial nenhum",
        penalty: "O MENOR RISCO DOS QUATRO. Leve cópia da receita + relatório em inglês e embalagem original",
      },
      {
