export const trip = {
  ...
  checklist: [
    ...
    { text: "🧳 DECIDIDO: a mala VAI JUNTO pro Luxor. Pagar 2 diárias a mais no Cairo (~R$ 300) só pra guardar bagagem não compensa, e deixar tudo o que você tem num hotel 2 estrelas por 3 dias é risco à toa. Em Luxor ela fica parada no quarto — o sofrimento é só a travessia de balsa, ida e volta. Se pesar, táxi pela ponte custa ~EGP 200", done: false, priority: "MÉDIA" },
  ...
  logistics: {
    ...
    openQuestions: [
      ...
      { title: "A balsa de Luxor pra Margem Ocidental aceita mala grande?", why: "O Happiness Guest House fica na Margem Ocidental e a mala agora vai junto — antes o plano era deixá-la no Cairo.", how: "É balsa pública, barata, sobe e desce a pé. Perguntar ao Happiness no chat do Booking se vale mais pegar táxi pela ponte com bagagem." },
