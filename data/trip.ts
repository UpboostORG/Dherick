export const trip = {
  ...
  checklist: [
    ...
    { text: "🧳 AO CHEGAR EM ATENAS DIA 12/10, perguntar no aeroporto se o guarda-volumes funciona 24h — você precisa retirar a mala entre 00h50 e 07h do dia 20/10. Fazer isso na chegada, não na véspera de ir pras ilhas: sobram 3 dias pra achar alternativa se não for 24h", done: false, priority: "ALTA" },
    ...
    { text: "🚨 CONFERIR DE NOVO 24-48H ANTES DE CADA VOO — é quando abre o check-in e você vê o horário real. Mudança de última hora é a que mais dói, porque você já está em movimento e sem tempo de replanejar", done: false, priority: "ALTA" },
    { text: "⚠️ Os 4 trechos onde mudança de horário DOI de verdade: (1) 30/09 EgyptAir 19h00 — você sai do AWS Summit contando com ela · (2) 12/10 Aegean 04h00 — checkout de madrugada em Giza · (3) 15/10 Ryanair 06h00 — táxi 04h15 de Omonia · (4) 20/10 Sky Express 07h00 — você já está no aeroporto desde 00h50. Nesses, conferir 48h antes é obrigatório", done: false, priority: "ALTA" },
    { text: "📧 Garantir que TODAS as companhias têm seu e-mail e telefone certos — é por aí que avisam mudança de horário. E o Gmail cheio (95%) pode fazer você não receber o aviso", done: false, priority: "ALTA" },
    ...
    { text: "🚨 COMPROVANTE RYANAIR — se tentarem cobrar bagagem de novo no portão, abrir a reserva no app e mostrar 'Priority and 10 kg Cabin Baggage · PURCHASED' + o e-mail de confirmação. Salvar print dos DOIS trechos no celular E na nuvem, offline. Não pagar duas vezes", done: false, priority: "ALTA" },
    ...
    { text: "🛡 ASSINAR O GENKI TRAVELER EM 22 OU 23/09, com início em 24/09 — cotação já feita: € 52,50/mês (R$ 310), região 'worldwide (limited in Canada & USA)', franquia € 50 por caso e ZERO em internação, período 24/09/2026 a 23/09/2027. ✅ Assinar dias antes NÃO cria carência: a cláusula 2.8 olha onde você estava na VÉSPERA DO INÍCIO (23/09, em Cuiabá), não quando assinou. ✅ Começar em 24/09 trava a faixa de 19 anos — você faz 20 no dia 28 e o preço depende da idade na data de início (5.2). 🚨 NÃO deixar pro dia 24: seu voo sai 02h10: se o cartão recusar ou o site travar, você resolve isso de madrugada com a mala na mão. Conferir que o nome sai DHERICK PRADO ABREU igual ao passaporte (a cotação saiu 'Dhérick' com acento) e salvar o Certificate of Insurance OFFLINE", done: false, priority: "ALTA" },
    ...
    { text: "🎯 Aporte 5 de 7 · R$ 2.306 até 15/09 → tudo pro Revolut, FECHA a reserva de emergência: faltam € 225 (R$ 1.328) + US$ 188 (R$ 978)", done: false, priority: "ALTA" },
    { text: "🎯 Aporte 6 de 7 · R$ 3.555 até 20/09 → dinheiro físico: US$ 400 (R$ 2.080) + € 250 (R$ 1.475), SEPARADO dos US$ 4.000. São 400 e não 250 porque o Life Pyramids Inn (Giza) e o hotel de Luxor só aceitam DINHEIRO", done: false, priority: "MÉDIA" },
    { text: "🎯 Aporte 7 de 7 · R$ 2.360 até 22/09 → € 400 EM EURO na conta da Wise (saldo digital, não espécie). Com euro já comprado, o cartão da Wise debita direto na Grécia e nos Bálcãs, sem conversão na hora do gasto", done: false, priority: "MÉDIA" },
    ...
    { text: "📸 CONFIRMAR que você TEM salvo o print da resposta da Kuwait dizendo que o reembolso está sendo processado — é a prova que o banco pede no chargeback. Se não achar no WhatsApp, pedir de novo por escrito ANTES do dia 21/09, enquanto eles ainda respondem", done: false, priority: "ALTA" },
