export const trip = {
  ...
  itinerary: [
    ...
    { date: "30/09-06/10", place: "Cairo · Downtown", status: "warning", tag: "6 diárias · HOTEL a reservar", detail: "Fase de TRABALHO. HOTEL (não hostel) no Downtown, com recepção 24h — você desembarca 21h40 e chega no hotel ~23h30. Daqui vai de Uber às pirâmides, ao GEM e ao Khan el-Khalili. ⚠️ Com o King's Gate cancelado, ESTA é a sua única cama no dia 30. Checkout dia 06 e não 05 de propósito: a última diária custa ~R$ 119 e te dá quarto e BANHO até sair pro Go Bus às 21h do dia 05 — sem ela seriam 10h na rua com mala antes de 9h de ônibus. A mala vai junto pro Luxor, nada fica guardado." },
