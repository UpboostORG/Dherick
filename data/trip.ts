export const trip = {
  ...
  checklist: [
    ...
    { text: "🎒 COMPRAR uma mochila pequena de 20L (~R$ 50-100) que caiba em 40×20×25 — SÓ pros 2 voos da Ryanair (15 e 20/10), onde o item pessoal grátis é bem menor que o das outras. Notebook cabe deitado (15,6\" = ~36×24×2 e a mochila tem 20cm de espessura). Sai muito mais barato que bagageiro nos 2 trechos (~R$ 300-700)", done: false, priority: "ALTA" },
