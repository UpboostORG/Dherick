export const trip = {
  ...
  checklist: [
    ...
    { text: "💵 SACAR pela Wise, só 2 vezes: US$250 em Dubai (set, sai AED, já cobre o Egito também) + €250 NA GRÉCIA (out, ao chegar em Atenas 12/10 — só lá sai euro de verdade) · ambos de graça · sempre moeda LOCAL no caixa", done: false, priority: "MÉDIA" },
