...
{ date: "30/09-06/10", place: "Cairo · Downtown", status: "warning", tag: "6 diárias · HOTEL a reservar", detail: "Fase de TRABALHO. Dorme em HOTEL no Downtown (Meramees ou New Panorama, recepção 24h — você desembarca 21h40 e chega ~23h30) e TRABALHA NO CONSOLEYA, 5 El-Fadl St, ~10 min a pé, aberto 24 horas por EGP 250/dia. ⚠️ CAIRO FICA 7H À FRENTE DE CUIABÁ: horário comercial brasileiro cai entre 16h e 01h no Cairo — por isso o coworking 24h importa. ⚠️ Com o King's Gate cancelado, esta é a sua única cama do dia 30. Checkout dia 06 e não 05: a diária extra garante quarto e banho até sair pro Go Bus às 21h do dia 05. A mala vai junto pro Luxor." },
  ...
  activities: {
    ...
    "Cairo": {
      ...
      items: [
        ...
        { name: "💻 Onde trabalhar de verdade — CONSOLEYA", desc: "5 El-Fadl St, Bab Al Louq, Abdeen — Downtown, ~10 min a pé do Meramees e do New Panorama. ABERTO 24 HORAS, todo dia. EGP 250 a diária (~US$ 5 · R$ 26). Fibra confirmada em avaliações, cozinha, café e recepção. Prédio antigo restaurado, cheio de startup egípcia — trabalhar de madrugada ali é normal. 5 dias de trabalho custam ~R$ 130, menos que uma diária de hotel. Alternativas: GrEEK Campus (Downtown), Comma na rua Mossadaq em Dokki, MQR em Maadi (EGP 200/dia, mas 20-25 km).", tip: "⚠️ Uma avaliação relata SINAL DE CELULAR FRACO dentro do prédio — lá o wi-fi é que segura, o chip 5G não serve de backup. E o horário 24h é o que resolve o fuso: Cairo fica 7h à frente de Cuiabá, então expediente comercial brasileiro cai entre 16h e 01h no Cairo" },
      ],
    },
    "Luxor": {
