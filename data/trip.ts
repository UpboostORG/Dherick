export const trip = {
  ...
  monthlyPurchases: [
    {
      month: "Julho 2026",
      note: "Travar hospedagens + seguro + começar dólares",
      items: [
    ...
    {
      month: "Agosto 2026",
      note: "Passagens Europa + hospedagens restantes + itens de viagem",
      items: [
        ...
        { text: "Ingressos Burj Khalifa (At the Top — online mais barato)", cost: "~US$ 40", done: false },
      ],
    },
    {
      month: "Setembro 2026",
      ...
      items: [
        { text: "Definir Macedônia do Norte (ir ou não) + hospedagem", cost: "~€ 150", done: false },
        { text: "Passagem Turquia → Macedônia do Norte (se for)", cost: "~€ 80", done: false },
        { text: "Kit farmácia viagem (remédios básicos, protetor solar)", cost: "~R$ 100", done: false },
