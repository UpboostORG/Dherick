export const trip = {
  ...
  checklist: [
    ...
    { text: "🚨 COMPRAR o bagageiro de mão da Ryanair ONLINE E CEDO, nos 2 trechos (14/10 e 19/10) — a Romantic Crown 45×32×12 cabe no limite pago deles (55×40×20). Comprado com antecedência sai ~€20-30 por trecho; no portão passa de €60. Não deixar pra última hora", done: false, priority: "ALTA" },
  ...
  logistics: {
    ...
    baggageChain: {
      ...
      legs: [
        ...
        { leg: "🚨 Ryanair · ATH↔JTR · 15 e 20/10", allow: "40×20×25 grátis · 55×40×20 pago", verdict: "PAGO", note: "O item grátis (40×20×25) não serve pra nada seu. Decisão: PAGAR o bagageiro nos 2 trechos e levar a Romantic Crown com o notebook — ela cabe em 55×40×20. Comprar online cedo (~€20-30/trecho contra €60+ no portão). A mala fica em Atenas: 23cm de profundidade não entra nem no bagageiro pago." },
