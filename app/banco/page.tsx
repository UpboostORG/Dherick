...
export default function BancoEmergencia() {
  ...
  useEffect(() => {
    const e = localStorage.getItem("__banco_eur_v7");
    const u = localStorage.getItem("__banco_usd_v7");
  ...
  useEffect(() => {
    if (!loaded) return;
    localStorage.setItem("__banco_eur_v7", String(eur));
    localStorage.setItem("__banco_usd_v7", String(usd));
