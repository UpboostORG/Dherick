  ...
  const countries = [
    {
      ...
      events: [
        { name: "AWS Summit Dubai", date: "qua 30/09 · 8h-18h30", venue: "Dubai World Trade Centre", price: "GRÁTIS", status: "INSCRITO ✓", desc: "Inscrito (e-mail dherick.sociais@). Voo EgyptAir MS906 às 19h00: dá pra pegar o dia quase todo — 7h checkout do hostel COM a mala · 8h crachá · sessões e keynote · sai de táxi ~16h30 pro DXB (~20 min). Você perde só o encerramento/networking das últimas 2h.", link: "https://aws.amazon.com/events/summits/dubai/" },
