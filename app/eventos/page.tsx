  ...
  const countries = [
    {
      ...
      events: [
        { name: "AWS Summit Dubai", date: "qua 30/09 · 8h-19h", venue: "Dubai World Trade Centre", price: "GRÁTIS", status: "INSCRITO ✓", desc: "Inscrito (e-mail dherick.sociais@). Plano do dia: 7h checkout do hostel COM a mala · 8h crachá · 9h-10h15 sessões · 10h15-11h05 palestra principal (pega ~50 dos 75 min) · 11h05 TÁXI pro DXB (~20 min, AED 45) · 11h35 balcão da Kuwait (limite: 90 min antes do voo das 13h05).", link: "https://aws.amazon.com/events/summits/dubai/" },
    ...
    },
    {
      ...
      events: [
        { name: "Web Summit Lisboa — side events", date: "9-12/11", venue: "Lisboa 🇵🇹", price: "Side events GRÁTIS · ingresso €895", status: "CONFIRMADO", desc: "Maior evento de tech da Europa (70 mil pessoas). Voluntariado é inviável (exige direito de trabalhar em PT — turista não tem). O plano: ir a Lisboa na semana e viver os side events e Night Summit gratuitos (Luma/Eventbrite) — pra networking, valem tanto quanto o pavilhão. Bônus: fala português!", link: "https://websummit.com/" },
        ...
        { name: "Slush Helsinki", date: "18-19/11", venue: "Helsinque, Finlândia 🇫🇮", price: "€395+ (voluntariado provavelmente inviável)", status: "A CONFIRMAR", desc: "O evento de founders/VCs mais respeitado da Europa. Voluntariado tende a exigir direito de trabalhar na Finlândia (mesmo caso do Web Summit) — confirmar regras antes de sonhar. Helsinque cara e gelada em nov. Conflita com DSC Belgrado.", link: "https://slush.org/" },
