  ...
  const countries = [
    {
      ...
      events: [
        { name: "AWS Summit Dubai", date: "qua 30/09 · 8h-19h", venue: "Dubai World Trade Centre", price: "GRÁTIS", status: "INSCRITO ✓", desc: "Inscrito (e-mail dherick.sociais@). Com o voo agora às 19h (EgyptAir MS906), dá pra curtir o evento INTEIRO: 7h checkout do hostel COM a mala · 8h crachá · sessões, keynote e o encerramento/networking até 18h30 · sai de táxi ~16h30-17h pro DXB (~20 min).", link: "https://aws.amazon.com/events/summits/dubai/" },
