...
export default function Metas() {
  ...
  const [invested, setInvested] = useState(4454);
  const [loaded, setLoaded] = useState(false);

  useEffect(() => {
    const savedRate = localStorage.getItem("__metas_rate");
    const savedInv = localStorage.getItem("__metas_invested_v7");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("__metas_invested_v7", String(invested));
